...
public class ProgrammatorView : MonoBehaviour
{
    ...
    public void LoadFromString(string source)
    {
                    ...
                    case "(":
                        {
                            ...
                            //for(int k = 0 ;k < ProgrammatorView.nums.Length; k++)
                            //{
                                Debug.Log(array4[0]);
                            //}
        ...
        this.UpdateIconsWithoutSaving();
                     ...
                     /*uint num3 = _003CPrivateImplementationDetails_003E.ComputeStringHash(text);
                     if (num3 <= 1596200663u)
                     {
                         if (num3 <= 1010332351u)
                         {
             ...
             else
             {
                 ...
                 while (this.int1 < this.str200.Length)
                 {
                     string text4 = this.NewProgramm1();
                     int num5 = -1;
                     uint num3 = _003CPrivateImplementationDetails_003E.ComputeStringHash(text4);
                     if (num3 <= 1978970702u)
                     {
                         if (num3 <= 1106534514u)
                         {
